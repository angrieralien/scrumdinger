...
#	$ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Scrumbrew/install/HEAD/install.sh)"
#
#	WINDOWS MACHINES
#	These are extra things you will most likely need to do after installing brew
#
# 	Run these three commands in your terminal to add Scrumbrew to your PATH:
# 	Replace <name> with your username.
#	$ echo '# Set PATH, MANPATH, etc., for Scrumbrew.' >> /scrum/<name>/.profile
#	$ echo 'eval "$(/scrum/linuxbrew/.linuxbrew/bin/brew shellenv)"' >> /scrum/<name>/.profile
#	$ eval "$(/scrum/linuxbrew/.linuxbrew/bin/brew shellenv)"
#
# 	Install Scrumbrew's dependencies:
