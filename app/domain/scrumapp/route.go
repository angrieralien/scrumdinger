...
func Routes(app *web.App, cfg Config) {
	...
	app.HandlerFunc(http.MethodGet, version, "/scrums", api.queryByUserID, authen, ruleAuthorizeScrum)
	app.HandlerFunc(http.MethodGet, version, "/scrums/{scrum_id}", api.queryByUserID, authen, ruleAuthorizeScrum)
	app.HandlerFunc(http.MethodPost, version, "/scrums", api.create, authen, ruleAuthorizeScrum)
